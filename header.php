...
<head>
	...
	<?php getfaircoin_coopshares_posts();  wp_head(); ?>
</head>
<body <?php body_class(); ?>>
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="container">
			...
			<div class="site-branding">
				...
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php //echo '<span class="logo-get">Get</span>Faircoin<span class="logo-exc">!</span>'; // bloginfo( 'name' ); // bumbum // ?></a></h1>
