		...
		<div class="container">
			...
			<div class="site-info row<?php echo is_active_sidebar( 'footer-1' ) ? ' has-widgets' : ''; ?>">
				...
				<div class="col-md-<?php echo $cols; ?>">
					...
					<p>
					<?php printf( __( '<span class="copyleft">&copy;</span> %d %s. <br />Contents of this website are licensed under a Peer Production, P2P Attribution-ConditionalNonCommercial-ShareAlikeLicense.', 'marketify' ), date( 'Y' ), get_bloginfo( 'name' ) ); // bumbum ?>
					</p>
				</div>
			</div><!-- .site-info -->
